...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LoginBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
	  ...
	  <ul>
	    ...
	    <li><a href="<?php echo JRoute::_((K2_JVERSION=='16')?'index.php?option=com_osmembership&view=register&id=1':'index.php?option=com_user&view=register'); ?>"><?php echo JText::_('K2_CREATE_AN_ACCOUNT'); ?></a></li>
	    <?php endif; ?>
	  </ul>
