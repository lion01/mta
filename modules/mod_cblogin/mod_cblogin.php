...
* $Id: mod_cblogin.php 1775 2012-02-21 14:40:06Z beat $
*
* @version 1.2
...
*/
	...
	echo '<span><input type="text" name="username" id="mod_login_username'.$id_sfx.'" class="inputbox'.$class_sfx.'" size="'.$name_lenght.'"' . $bgstyleUser . ' /></span>';
	if ($horizontal) {
		echo "&nbsp;\n";
	} elseif ( $jVersion == 2 ) {
		echo '</p>';
