 ...
 *
 */
class TravelViewCarts extends JView
{
	/*
	...
	function display_carts($tpl = null)
	{
		$app = JFactory::getApplication();
		$option	= JRequest::getCmd('option');
		...
		$document->title = $document->titlePrefix . JText::_("TRAVEL_LAYOUT_CARTS") . $document->titleSuffix;
		...
		if ($access->get('core.delete') || $access->get('core.delete.own'))
			$bar->appendButton( 'Standard', "delete", "TRAVEL_JTOOLBAR_DELETE", "delete", true);
