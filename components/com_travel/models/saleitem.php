...
/**
 * Travel Component Saleitem Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelSaleitem extends TravelModelItem
{
	var $_name_plur = 'saleitems';
	var $params;
	...
	/**
	 * Method to initialise the saleitem data
	 *
	 * @access	private
	...
	/**
	 * Method to update saleitem in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_saleitems`'
				. ' WHERE id IN ( '.$cids.' )';
