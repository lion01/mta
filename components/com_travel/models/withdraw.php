...
/**
 * Travel Component Withdraw Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelWithdraw extends TravelModelItem
{
	var $_name_plur = 'withdraws';
	var $params;
	...
	/**
	 * Method to initialise the withdraw data
	 *
	 * @access	private
	...
	/**
	 * Method to build a the query string for the Withdraw
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to update withdraw in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_withdraws`'
				. ' WHERE id IN ( '.$cids.' )';
