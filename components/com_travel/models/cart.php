...
/**
 * Travel Component Cart Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelCart extends TravelModelItem
{
	var $_name_plur = 'carts';
	var $params;
	...
	/**
	 * Method to initialise the cart data
	 *
	 * @access	private
	...
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_carts`'
				. ' WHERE id IN ( '.$cids.' )';
