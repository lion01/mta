...
/**
 * Travel Component Withdraws Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelWithdraws extends TravelModelList
{
	var $_name_sing = 'withdraw';
	...
	function _buildQueryOrderBy($order = array(), $pre_order = 'a.amount')
	{
