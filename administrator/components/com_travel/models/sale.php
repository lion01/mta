...
/**
 * Travel Component Sale Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelSale extends TravelModelItem
{
	var $_name_plur = 'sales';
	var $params;
	...
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_sales`'
				. ' WHERE id IN ( '.$cids.' )';
