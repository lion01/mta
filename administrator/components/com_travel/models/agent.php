...
/**
 * Travel Component Agent Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelAgent extends TravelModelItem
{
	var $_name_plur = 'agents';
	var $params;
	...
	/**
	 * Method to initialise the agent data
	 *
	 * @access	private
	...
	function _buildQuery()
	{
		...
		{
			case 'agent': return $this->_buildQuery_agent(); break;
	...
	/**
	 * Method to update agent in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_agents`'
				. ' WHERE id IN ( '.$cids.' )';
