...
/**
 * Travel Component Withdrawitem Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelWithdrawitem extends TravelModelItem
{
	var $_name_plur = 'withdrawitems';
	var $params;
	...
	/**
	 * Method to initialise the withdrawitem data
	 *
	 * @access	private
	...
	function _initData()
	{
		if (empty($this->_data))
		{
			...
			$data->withdraw_id = JRequest::getInt('filter_withdraw_id', $this->getState('filter.withdraw_id'));
			$data->total_comission = null;
	...
	/**
	 * Method to build a the query string for the Withdrawitem
	 *
	 * @access public
	 * @return integer
	 */
	function _buildQuery()
	{
		...
		switch($this->_active['predefined'])
		{
			...
			$query = 'SELECT a.*'
					...
					.	' FROM `#__travel_withdrawitems` AS a'
	...
	/**
	 * Method to update withdrawitem in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to save the withdrawitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to delete a withdrawitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_withdrawitems`'
				. ' WHERE id IN ( '.$cids.' )';
