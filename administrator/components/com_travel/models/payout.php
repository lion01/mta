...
/**
 * Travel Component Payout Model
 *
 * @package		Joomla
 * @subpackage	Travel
 *
 */
class TravelModelPayout extends TravelModelItem
{
	var $_name_plur = 'payouts';
	var $params;
	...
	/**
	 * Method to initialise the payout data
	 *
	 * @access	private
	...
	/**
	 * Method to build a the query string for the Payout
	 *
	 * @access public
	 * @return integer
	 */
	function _buildQuery()
	{
		...
		{
			case 'payout': return $this->_buildQuery_payout(); break;
	...
	/**
	 * Method to update payout in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__travel_payouts`'
				. ' WHERE id IN ( '.$cids.' )';
