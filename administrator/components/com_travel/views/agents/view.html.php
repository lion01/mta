 ...
 *
 */
class TravelViewAgents extends JView
{
	/*
	...
	function display_default($tpl = null)
	{
		...
		$document->title = $document->titlePrefix . JText::_("TRAVEL_LAYOUT_AGENTS") . $document->titleSuffix;
		...
		//expired_date
		$this->filters['expired_date'] = new stdClass();
		$this->filters['expired_date']->from = $model->getState("filter.expired_date_from");
		$this->filters['expired_date']->to = $model->getState("filter.expired_date_to");
