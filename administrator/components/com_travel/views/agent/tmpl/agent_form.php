    ...
    <table class="admintable">
        ...
        <tr>
            ...
            <td>
                ...
                ?>
                <input type="text" id="id_search_user" name="search_user" value="<?php echo $this->agent->user_id; ?>" size="8" />
            </td>
        </tr>
        <tr>
            <td align="right" class="key">
            ...
            <td>
                ...
                ?>
                <input type="text" id="id_search_parent" name="search_parent" value="<?php echo $this->agent->parent; ?>" size="8" />
            </td>
        </tr>
        <tr>
            <td align="right" class="key">
