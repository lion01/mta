...
//Deprecated
	...
	if ($('filter_created_date_from') != null)
		$('filter_created_date_from').value='';
	if ($('filter_created_date_to') != null)
		$('filter_created_date_to').value='';
	...
	<div>
		...
		<div style="float:left">
			<!-- RANGE : Created Date  -->
				...
				<div class='filter range filter_created_date'>
		

					<?php echo JDom::_('html.form.input.range', array(
												'rangeNameSpace' => 'html.form.input.calendar',
												'dataKey' => 'filter_created_date',
												'dataValueFrom' => $this->filters['created_date']->from,
												'dataValueTo' => $this->filters['created_date']->to,
												'labelFrom' => "TRAVEL_JSEARCH_FROM",
												'labelTo' => "TRAVEL_JSEARCH_TO",
												'size' => 10,
												'alignHz' => true,
