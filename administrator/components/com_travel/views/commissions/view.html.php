 ...
 *
 */
class TravelViewCommissions extends JView
{
	/*
	...
	function display_default($tpl = null)
	{
		...
		$document->title = $document->titlePrefix . JText::_("TRAVEL_LAYOUT_COMMISSIONS") . $document->titleSuffix;
		...
		//created_date
		$this->filters['created_date'] = new stdClass();
		$this->filters['created_date']->from = $model->getState("filter.created_date_from");
		$this->filters['created_date']->to = $model->getState("filter.created_date_to");
