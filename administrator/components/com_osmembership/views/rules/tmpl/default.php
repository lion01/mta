	...
	<thead>
		<tr>
			...
			<th class="title" style="text-align: left;">
				<?php echo JHTML::_('grid.sort',  JText::_('OSM_FROM_PLAN'), 'b.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>											
			<th class="title" style="text-align: left;">
				<?php echo JHTML::_('grid.sort',  JText::_('OSM_TO_PLAN'), 'c.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>
			<th class="title" style="text-align: left;">
				<?php echo JHTML::_('grid.sort',  JText::_('OSM_PRICE'), 'a.price', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>							
			<th class="title" style="text-align: left;">
				<?php echo JHTML::_('grid.sort',  JText::_('OSM_MAX_PRESENCE'), 'a.max_presence', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>
			<th class="title" style="text-align: left;">
				<?php echo JHTML::_('grid.sort',  JText::_('OSM_MIN_PRESENCE'), 'a.min_presence', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>
			<th width="5%">
