...
$document->addScript($gpath."/js/jquery.jcarousel.min.js");
$document->addStyleSheet($gpath."/css/jquery.jcarousel.css");
?>
...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul id="<?php if($params->get('moduleclass_sfx')) echo $params->get('moduleclass_sfx'); ?>">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
	  ...
	  <a class="moduleItemDateCreated-link" href="<?php echo $item->link; ?>">
			<span class="moduleItemDateCreated">
				<?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC6')); ?>
			</span>
	</a>
      <?php endif; ?>
      ...
      <?php endif; ?>
      	...
      	<?php if($params->get('itemIntroText')): ?>
			<?php echo substr($item->introtext,0, 150); ?> <!-- Last digit is a number of introtext symbols displayed -->
      	<?php endif; ?>
      </div>
      <?php endif; ?>
