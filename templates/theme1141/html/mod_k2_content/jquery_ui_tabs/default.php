...
<div id="<?php echo $params->get('moduleclass_sfx'); ?>">
	...
	<ul>
		<?php foreach ($items as $key=>$item):	?>
			<li>
				<a class="moduleTabTitle" href="#<?php echo 'tab-'.$key; ?>"><?php echo $item->title; ?></a>
			</li>
		<?php endforeach; ?>
	</ul>
	<?php endif; ?>
	...
	<?php if(count($items)): ?>
		<?php foreach ($items as $key=>$item):	?>
		<div id="<?php echo 'tab-'.$key; ?>" class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
...
<?php
$document->addStyleSheet($gpath."/css/tabs.css");
 ?>
...
var $tabs_container_id = $('#<?php if($params->get('moduleclass_sfx')) echo $params->get('moduleclass_sfx'); ?>');
