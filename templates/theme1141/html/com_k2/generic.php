		...
		<div class="genericItemView">
			...
			<div class="genericItemHeader">
				...
				<span class="genericItemDateCreated">
					<span class="day"><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC9')); ?></span>
					<span class="moth"><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC10')); ?></span>
				</span>
				<?php endif; ?>
