			...
			<div class="catItemImageBlock">
				<span class="catItemImage">
					<?php if($this->params->get('itemImageXL') !== 0): ?>
						<a class="modal" href="<?php echo $this->item->imageXLarge; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
					...
					<?php else: ?>
						<a class="modal" href="<?php echo $this->item->image; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
							<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"/>
							<span class="zoomIcon"></span>
						</a>				
					<?php endif; ?>
...
<!-- Date created -->
		<?php if($this->item->params->get('catItemDateCreated')): ?>
			<span class="catItemDateCreated">
				<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC5')); ?>
			</span>
		<?php endif; ?>
...
<!-- Item Hits -->		
			<?php if($this->item->params->get('catItemHits')): ?>
				<div class="catItemHitsBlock">
					<span><?php echo JText::_('GALLERY_VIEWS'); ?></span>
